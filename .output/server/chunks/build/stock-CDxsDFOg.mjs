...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grow-[0] h-full flex divide-x overflow-hidden" }, _attrs))}><div class="shrink-0 w-60 h-full overflow-y-scroll scrollbar-hide"><div><input class="px-4 py-2 bg-neutral-100 w-full focus:outline-none" type="text" placeholder="search"${ssrRenderAttr("value", unref(search))}></div>`);
      if (unref(indices)) {
        _push(`<!--[-->`);
...
//# sourceMappingURL=stock-CDxsDFOg.mjs.map
