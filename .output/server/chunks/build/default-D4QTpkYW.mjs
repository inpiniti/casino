...
import { useSSRContext, defineComponent, computed, mergeProps, unref, withCtx, renderSlot, createVNode, createTextVNode } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderList } from 'vue/server-renderer';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div class="grow-[0] h-full flex divide-x overflow-hidden"><div class="w-32 divide-y h-full overflow-y-scroll scrollbar-hide"><!--[-->`);
  ssrRenderList(50, (item) => {
    _push(`<div class="px-4 py-2">\uBA54\uB274</div>`);
  });
  _push(`<!--]--></div><div class="grow-[0] w-full overflow-y-scroll scrollbar-hide">`);
...
//# sourceMappingURL=default-D4QTpkYW.mjs.map
