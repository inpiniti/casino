import { s as setInterval, _ as _sfc_main$c, a as _sfc_main$1$1 } from './interval-_uFmYVj1.mjs';
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const color = computed(() => {
      switch (Math.floor(props.count / 75) - props.\uAC10\uB3C4) {
        case 1:
          return "bg-red-500";
        case 2:
    ...
    const \uAC00\uC774\uB4DC = computed(() => {
      return Math.max(0, Math.floor(props.count / 75) - props.\uAC10\uB3C4);
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Card = _sfc_main$1$1;
      _push(ssrRenderComponent(_component_Card, mergeProps({
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const color = computed(() => {
      switch (Math.floor(props.count / 15) - props.\uAC10\uB3C4) {
        case 1:
          return "bg-red-500";
        case 2:
          return "bg-orange-500";
    ...
    const \uAC00\uC774\uB4DC = computed(() => {
      return Math.max(0, Math.floor(props.count / 15) - props.\uAC10\uB3C4);
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Card = _sfc_main$1$1;
      _push(ssrRenderComponent(_component_Card, mergeProps({ class: "w-fit px-2 py-1 flex flex-col bg-emerald-500 border-0" }, _attrs), {
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const color = computed(() => {
      switch (Math.floor(props.count / (props.description / 2)) - props.\uAC10\uB3C4) {
        case 1:
          return "bg-red-500";
        case 2:
          return "bg-orange-500";
    ...
    const \uAC00\uC774\uB4DC = computed(() => {
      return Math.max(
        0,
        Math.floor(props.count / (props.description / 2)) - props.\uAC10\uB3C4
      );
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Card = _sfc_main$1$1;
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const color = computed(() => {
      switch (Math.floor(props.count / 4) - props.\uAC10\uB3C4) {
        case 1:
          return "bg-red-500";
        case 2:
          return "bg-orange-500";
    ...
    const \uAC00\uC774\uB4DC = computed(() => {
      return Math.max(0, Math.floor(props.count / 4) - props.\uAC10\uB3C4);
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Card = _sfc_main$1$1;
      _push(ssrRenderComponent(_component_Card, mergeProps({
...
//# sourceMappingURL=daisai-FdlT_Tm5.mjs.map
